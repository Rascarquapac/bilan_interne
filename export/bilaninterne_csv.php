...
/*!
 * \file bilan_interne_csv.php
 * \brief Re-generates the detailled balance sheet and outputs CSV file  
 * 
 * It regenerates de detailled balance sheet from user data and creates a CSV output.
...
/*! \file 
*   \brief Generates the the detailled balace sheet and outputs CSV file  
*/
...
//print_r($result);
$bilaninterne->output_csv($result,$cn);
